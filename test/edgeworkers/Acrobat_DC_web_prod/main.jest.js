  ...
  it("responseProvider", async () => {
    ...
    responsePromise.then(response => {
      ...
      expect(fetches).toEqual([
        ...
        'https://www.adobe.com//scripts/scripts.js',
        'https://www.adobe.com//blocks/dc-converter-widget/dc-converter-widget.js',
        'https://www.adobe.com//styles/styles.css',
        'https://www.adobe.com/libs/styles/styles.css',
        'https://www.adobe.com//blocks/verb-widget/verb-widget.css',
