...
export default async function init(element) {
  ...
  if (window.location.hostname === 'www.adobe.com' || window.location.hostname === 'acrobat.adobe.com' || window.location.hostname === 'sign.ing' || window.location.hostname === 'edit.ing') {
  ...
  window.addEventListener('DC_Hosted:Error', (err) => {
    ...
    if (dropZone && !dropZone.classList.contains('unavailable')) {
      ...
      dropZone.innerHTML = '<img src="/dc-shared/img/icons/error.svg"><p>We apologize for the inconvenience. We are working hard to make the service available. Please check back shortly.</p>';
